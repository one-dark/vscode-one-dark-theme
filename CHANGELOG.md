...
- Fix delete keyword highlight error
- Improve peek background color
- Improve menu foreground & active tab foreground
- Fixed TypeScript `keyof` highlight error
- Fixed C++ highlight error
- Fix java highlight
  - `@` on annotation is now white
  - `instanceof` is now highlighted
  - `List<String>` is now standardized. The bracket is force to white and the type have now same color of type
...
- Support Markdown underscore-style headers

## 4.3.0 | 2019-06-03

- Add support for XI language
